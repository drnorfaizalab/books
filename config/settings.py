...
INSTALLED_APPS = [
    ...
    'django.contrib.sites', # when we add allauth package
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (str(BASE_DIR.joinpath('static')),) # from collectstatics for production
...
# the nittigritty of django-allauth
LOGIN_REDIRECT_URL = 'home' #to redirect all login to the homepage
LOGOUT_REDIRECT_URL = 'home' #to redirect all logout to the homepage
SITE_ID = 1 # new
